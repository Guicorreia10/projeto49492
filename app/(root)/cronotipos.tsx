...
const perguntas = [
  {
    id: 1,
    texto: '1. Considerando apenas o seu bem-estar pessoal, e com liberdade total para planear o seu dia, a que horas se levantaria?',
    opcoes: [
  ...
  {
    id: 2,
    texto: '2. Considerando apenas o seu bem estar pessoal e com total liberdade de planear a sua noite, a que horas se deitaria?',
    opcoes: [
  ...
  {
    id: 3,
    texto: '3. Depende do despertador para acordar de manhã?',
    opcoes: [
  ...
  {
    id: 4,
    texto: '4. Considera fácil acordar de manhã?',
    opcoes: [
  ...
  {
    id: 5,
    texto: '5. Você se sente alerta durante a primeira meia hora depois de acordar?',
    opcoes: [
  ...
  {
    id: 6,
    texto: '6. Como é o seu apetite durante a primeira meia hora depois de acordar?',
    opcoes: [
      { texto: 'Muito bom', valor: 4 },
      { texto: 'Razoavelmente bom', valor: 3 },
      { texto: 'Um pouco mau', valor: 2 },
      { texto: 'Muito mau', valor: 1 },
    ],
  },
  {
    id: 7,
    texto: '7. Após meia hora de acordar, sente-se cansado?',
    opcoes: [
  ...
  {
    id: 8,
    texto: '8. Na falta de compromissos no dia seguinte e comparando com a sua hora habitual, a que horas se deitaria?',
    opcoes: [
  ...
  {
    id: 9,
    texto: '9. Um amigo sugeriu o horário das 07:00 às 08:00 horas da manhã para a prática de exercício físico. Considerando apenas o seu bem estar pessoal, o que acha da prática de exercício no respetivo horário?',
    opcoes: [
  ...
  {
    id: 10,
    texto: '10. A que horas da noite se sente cansado e com vontade de dormir?',
    opcoes: [
      { texto: '20:00 às 21:00', valor: 5 },
      { texto: '21:00 às 22:15', valor: 4 },
  ...
  {
    id: 11,
    texto: '11. Quer estar no máximo da sua forma para fazer um teste de que dura 02:00 horas e de que tem conhecimento ser mentalmente cansativo. Considerando apenas o seu bem estar pessoal, qual dos seguintes horários escolheria para realizar o teste?',
    opcoes: [
  ...
  {
    id:12,
    texto: '12. No caso de se deitar às 23:00 horas, em que nível de cansaço se encontraria?',
    opcoes: [
  ...
  {
    id: 13,
    texto: '13. Por alguma razão vai dormir várias horas mais tarde do que é costume. Se no dia seguinte não tiver hora certa para acordar, o que aconteceria?',
    opcoes: [
  ...
  {
    id:14,
    texto: '14. Se tiver que ficar acordado das 04:00 às 06:00 horas da manhã para realizar uma tarefa e não possuir compromissos no dia seguinte, o que faria?',
    opcoes: [
    ...
    {
        id:15,
        texto: '15. Se necessitasse de fazer duas horas de exercício físico pesado e considerando apenas o seu bem estar pessoal, a que horas o faria?',
        opcoes: [
    ...
    {
        id:16,
        texto:'16. Decidiu fazer exercício físico. Um amigo sugeriu o horário das 22:00 às 23:00 horas, duas vezes por semana. Considerando apenas o seu bem estar pessoal, o que acha do exercício físico nesse horário?',
        opcoes: [
    ...
    {
        id:17,
        texto:'17. Suponha que tem a possibilade de escolher o seu próprio horário de trabalho e que deve trabalhar durante cinco horas seguidas por dia. Imagine que seja um serviço interessante e que ganharia por produção. Qual horário escolheria para começar?',
        opcoes: [
    ...
    {
        id:18,
        texto:'18. A que horas do dia atinge o seu melhor momento de bem estar?',
        opcoes: [
            {texto: '05:00 às 08:00', valor: 5 },
            {texto: '08:00 às 10:00', valor: 4 },
    ...
    {
        id:19,
        texto:'19. Fala-se em pessoas matutinas e vespertinas (as primeiras preferem e gostam de acordar cedo e dormir cedo, as segundas de acordar tarde e dormir tarde). Com qual destas se identifica?',
        opcoes: [
