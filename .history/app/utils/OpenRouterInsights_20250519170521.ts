...
- 2 insights sobre medicamentos (avalia tipo de medicamento, quantidade e descrição comenta valores anormais, assume quantidade como um comprimido e no tipo diabetes e sono a descrição com o nome do comprimido)
