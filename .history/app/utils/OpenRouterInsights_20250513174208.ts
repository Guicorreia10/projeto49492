  ...
  try {
    const resposta = await fetch("https://openrouter.ai/api/v1/chat/completions", {
      ...
      headers: {
        ...
        "HTTP-Referer": "https://glicosleep.app", // opcional mas ajuda no rate limit
      },
      body: JSON.stringify({
        model: "gpt-3.5-turbo", // ou outro modelo se quiseres
        messages: mensagens,
        temperature: 0.7,
      }),
    });
