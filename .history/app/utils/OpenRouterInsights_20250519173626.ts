...
- 1 insights sobre medicamentos (avalia tipo de medicamento, quantidade e descrição comenta valores anormais, assume quantidade como um comprimido e no tipo diabetes e sono a descrição com o nome do comprimido)
- 1 sobre glicose (níveis, oscilações)
- 1 sobre sono (quantidade, consistência)
- 1 sobre alimentação (qualidade, IG, CG)
- 1 sobre atividade do smartwatch (passos, exercício, sono)
