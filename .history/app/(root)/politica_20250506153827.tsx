  ...
  return (
    <SafeAreaView className="flex-1 bg-white px-6">
      <ScrollView contentContainerStyle={{ paddingBottom: 40 }}>
        ...
        <Text className="text-gray-700 mb-4">Atualizado em: [Data de hoje]</Text>

        <Section title="1. Informações Recolhidas">
          <Bullet>Dados de registo: nome, email e palavra-passe</Bullet>
          <Bullet>Dados de saúde: níveis de glicose, horas de sono, serviços utilizados</Bullet>
        ...
        <Section title="4. Armazenamento e Segurança">
          <Text className="text-base text-gray-700">
            Todos os dados são armazenados de forma segura usando a infraestrutura da Supabase.
        ...
        <Section title="5. Direitos do Utilizador">
          ...
          <Text className="mt-2 text-base text-gray-700">
            Para tal, contacte-nos através de: <Text className="font-semibold">suporte@glicosleep.com</Text>
          </Text>
        </Section>
        ...
        <Text className="mt-6 text-base text-gray-700">
          Para qualquer dúvida, entre em contacto connosco em <Text className="font-semibold">suporte@glicosleep.com</Text>.
        </Text>
