      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        {cronotipo ? (
          <View style={styles.card}>
            ...
            <Text style={styles.cardValue}>{cronotipo.pontuacao} pontos</Text>
            <Text style={styles.cardText}>Tipo: {cronotipo.tipo}</Text>
          </View>
        ) : (
          <TouchableOpacity style={styles.botaoCronotipo} onPress={() => router.push("../(root)/cronotipo")}>
