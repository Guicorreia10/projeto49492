  ...
  const handleLogout = async () => {
    try {
      ...
      if (error instanceof Error) {
        Alert.alert("Erro", "Erro ao terminar sessão: " + error.message);
      } else {
      ...
      <ScrollView contentContainerClassName="pb-32 px-6">
        ...
        <View className="mt-10 space-y-4">
          ...
          >
            <View className="flex-row items-center space-x-3">
              ...
              <Text className="text-base font-medium">O Meu Histórico</Text>
            </View>
          ...
          >
            <View className="flex-row items-center space-x-3">
              <Image source={icons.wallet} className="w-6 h-6" />
              <Text className="text-base font-medium">Carteira</Text>
            </View>
            <Image source={icons.rightArrow} className="w-4 h-4" />
          </TouchableOpacity>
        </View>
        ...
        <View className="mt-10 border-t border-gray-300 pt-6">
          ...
          <TouchableOpacity
            className="flex-row items-center justify-between bg-gray-100 p-4 rounded-xl"
            onPress={() =>
              Alert.alert("Alterar Idioma", "Escolha o idioma:", [
