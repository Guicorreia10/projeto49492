  ...
  const [history, setHistory] = useState<RoleMessage[]>([
    {
      role: 'system',
      content:
        'És o GlicoBot, um assistente amigável especializado em sono, glicose e bem-estar, que fala em português de Portugal.',
    },
  ]);
  ...
  const sendMessage = useCallback(async () => {
    ...
    try {
      ...
      const botContent =
        ...
        'Desculpa, mas não consegui criar uma resposta.';
