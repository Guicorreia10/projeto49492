  ...
  return (
    <SafeAreaView style={{ backgroundColor: '#f0f0f0', flex: 1 }}>
      ...
      <ScrollView contentContainerStyle={{ paddingHorizontal: 20, paddingBottom: 40 }}>
        ...
        {/* Secção: Monitorização da Glicose */}
        <View style={{ marginTop: 20, backgroundColor: '#fff', borderRadius: 10, padding: 20, shadowColor: '#000', shadowOpacity: 0.1, shadowRadius: 10, elevation: 5 }}>
          <Text style={{ fontSize: 20, fontWeight: 'bold', color: '#333' }}>🩸 Monitorização de Glicose</Text>
          <Text style={{ fontSize: 14, color: '#666', marginTop: 10, lineHeight: 20 }}>
            Registe os seus níveis de glicose ao longo do dia de forma a visualizar gráficos para acompanhar tendências e controlar a sua saúde de forma mais facilitada. 
          </Text>
        </View>

        {/* Secção: Conexões Bluetooth */}
        <View style={{ marginTop: 20, backgroundColor: '#fff', borderRadius: 10, padding: 20, shadowColor: '#000', shadowOpacity: 0.1, shadowRadius: 10, elevation: 5 }}>
          <Text style={{ fontSize: 20, fontWeight: 'bold', color: '#333' }}>📡 Conexões Bluetooth</Text>
          <Text style={{ fontSize: 14, color: '#666', marginTop: 10, lineHeight: 20 }}>
            A aplicação conecta-se diretamente com dispositivos compatíveis via Bluetooth de forma a facilitar a sincronização de dados, como qualidade do sono, passos e exercício físico praticado. Certifique-se de ativar o Bluetooth no seu dispositivo quando tentar conectar o seu wearable.
          </Text>
        </View>

        {/* Secção: Recomendações Personalizadas */}
        <View style={{ marginTop: 20, backgroundColor: '#fff', borderRadius: 10, padding: 20, shadowColor: '#000', shadowOpacity: 0.1, shadowRadius: 10, elevation: 5 }}>
